    ...
    <div className="App-header"> {/* DÜZELTME BURADA */}
      ...
      <form onSubmit={createProduct} className="product-form">
        ...
        <div className="form-field">
          <input type="text" name="urun_adi" id="urun_adi" placeholder=" " value={newProduct.urun_adi} onChange={handleInputChange} onFocus={handleFocus} required />
          <label htmlFor="urun_adi">Ürün Adı</label>
        </div>
        
        <div className="form-field">
          <input type="text" name="cinsi" id="cinsi" placeholder=" " value={newProduct.cinsi} onChange={handleInputChange} onFocus={handleFocus} />
        ...
        <div className="form-field">
          <input type="text" name="aciklama" id="aciklama" placeholder=" " value={newProduct.aciklama} onChange={handleInputChange} onFocus={handleFocus} />
